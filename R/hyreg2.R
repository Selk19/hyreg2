...
#'
#'
#'latent, id_col, classes_only: in some situations, it can be useful to
...
#' @param mod modeloutput from hyreg2 oder hyreg2_het. If latent was "cont" oder "dich" only one part of the output list can be used.
#'            write modeloutput[[z]], where z is the component you want to extract
